var en_lang = {
	...
	addingNewItemsBody1: "When adding a new item you can specify the following details",
	addingNewItemsBody2: "Name",
	addingNewItemsBody3: "This is a required field. It must describe the item, ideally not with a broad term. For example, if you buy a lot of Coca-Cola then the name of the item should be 'Coca-Cola' and not 'Soft Drink'.",
	addingNewItemsBody4: "Description",
	addingNewItemsBody5: "An optional description for the item. This description appears only on the exported Excel spreadsheet.",
	addingNewItemsBody6: "Price",
	addingNewItemsBody7: "An optional price for the item.", 
	addingNewItemsBody8: "If there is no standard price for the item, then this field should be left blank. This way, when you click on the item, ExpenseMe will ask you for the price you paid that particular time.",
	addingNewItemsBody9: "But if the item has a fixed price, for example your favorite tobacco, then it's good to specify it so that you don't have to enter it every time you click on the item.",
	addingNewItemsBody10: "Category",
	addingNewItemsBody11: "Optional field which allows some grouping of items. This determine the icon that will be used for the item's button and also for later processing of the expenses, for example if you want to see how much you are spending on drinks in general and not only on Coca-Cola.",
	addingNewItemsBody12: "If no category is specified, then the first letter of the item's name will be used for the item's button.",
	...
	rateBody: "It won't take more than a minute. ",
	rateHeader: "If you enjoy using ExpenseMe, would you mind taking a moment to rate it? ",
